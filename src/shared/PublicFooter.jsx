...
export const PublicFooter = () => {
  return (
      <footer className="p-4 bg-white shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://leksilab.com" className="hover:underline" target="_blank">Leksilab</a>. All Rights Reserved.
        </span>
